...
func main() {
	...
	for {
		...
		case xproto.KeyPressEvent:
			// See https://pkg.go.dev/codeberg.org/gruf/go-xgb/xproto#KeyPressEvent
		...
		case xproto.DestroyNotifyEvent:
			...
			// https://codeberg.org/gruf/go-xgbutil/blob/master/_examples/graceful-window-close/main.go
			return
		}
	}
}

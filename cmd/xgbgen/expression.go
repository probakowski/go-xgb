...
func (e *Padding) Reduce(prefix string) string {
	...
	return fmt.Sprintf("internal.Pad4(%s)", e.Expr.Reduce(prefix))
}
...
func (e *PopCount) Reduce(prefix string) string {
	...
	return fmt.Sprintf("internal.PopCount(%s)", e.Expr.Reduce(prefix))
}
...
func (e *EnumRef) Eval() int {
	panic("Cannot evaluate an 'EnumRef'. It is not concrete.")
}
...
func (e *SumOf) Eval() int {
	panic("Cannot evaluate a 'SumOf'. It is not concrete.")
}

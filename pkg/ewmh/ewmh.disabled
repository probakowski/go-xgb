...
func DesktopGeometryGet(xconn *xgb.XConn) (*DesktopGeometry, error) {
...
func DesktopGeometrySet(xconn *xgb.XConn, dg *DesktopGeometry) error {
...
func DesktopGeometryReq(xconn *xgb.XConn, dg *DesktopGeometry) error {
...
func DesktopLayoutGet(xconn *xgb.XConn) (dl *DesktopLayout, err error) {
...
func DesktopLayoutSet(xconn *xgb.XConn, orientation, columns, rows,
	startingCorner uint,
) error {
...
func DesktopViewportGet(xconn *xgb.XConn) ([]DesktopViewport, error) {
	coords, err := xprop.PropValNums(xprop.GetProperty(xu, xu.RootWin(), "_NET_DESKTOP_VIEWPORT"))
	if err != nil {
		return nil, err
	}
...
func DesktopViewportSet(xconn *xgb.XConn, viewports []DesktopViewport) error {
...
func DesktopViewportReq(xconn *xgb.XConn, x, y int) error {
...
func FrameExtentsGet(xconn *xgb.XConn,
	win xproto.Window,
) (*FrameExtents, error) {
...
func FrameExtentsSet(xconn *xgb.XConn, win xproto.Window,
...
// or Resize.
func MoveresizeWindow(xconn *xgb.XConn, win xproto.Window,
	x, y, w, h int,
) error {
...
func ResizeWindow(xconn *xgb.XConn, win xproto.Window, w, h int) error {
	return MoveresizeWindowExtra(xu, win, 0, 0, w, h, xproto.GravityBitForget,
		2, false, false)
}

// _NET_MOVERESIZE_WINDOW req move only
func MoveWindow(xconn *xgb.XConn, win xproto.Window, x, y int) error {
...
func MoveresizeWindowExtra(xconn *xgb.XConn, win xproto.Window, x, y, w, h,
	gravity, source int, usex, usey bool,
) error {
	flags := gravity
	flags |= source << 12
	if usex {
...
func RestackWindow(xconn *xgb.XConn, win xproto.Window) error {
	return RestackWindowExtra(xu, win, xproto.StackModeAbove, 0, 2)
}

// _NET_RESTACK_WINDOW req extra
func RestackWindowExtra(xconn *xgb.XConn, win xproto.Window, stackMode int,
	sibling xproto.Window, source int,
) error {
...
func ShowingDesktopGet(xconn *xgb.XConn) (bool, error) {
...
func ShowingDesktopSet(xconn *xgb.XConn, show bool) error {
	var showInt uint
	if show {
		showInt = 1
	} else {
...
func ShowingDesktopReq(xconn *xgb.XConn, show bool) error {
	var showInt uint
	if show {
		showInt = 1
	} else {
...
// _NET_SUPPORTED get
func SupportedGet(xconn *xgb.XConn) ([]string, error) {
...
func SupportedSet(xconn *xgb.XConn, atomNames []string) error {
...
func SupportingWmCheckGet(xconn *xgb.XConn,
	win xproto.Window,
) (xproto.Window, error) {
...
func SupportingWmCheckSet(xconn *xgb.XConn, win xproto.Window,
	wmWin xproto.Window,
) error {
...
func VirtualRootsGet(xconn *xgb.XConn) ([]xproto.Window, error) {
	return xprop.PropValWindows(xprop.GetProperty(xu, xu.RootWin(),
		"_NET_VIRTUAL_ROOTS"))
}

// _NET_VIRTUAL_ROOTS set
func VirtualRootsSet(xconn *xgb.XConn, wins []xproto.Window) error {
...
func WmAllowedActionsSet(xconn *xgb.XConn, win xproto.Window,
	atomNames []string,
) error {
	atoms, err := xprop.StrToAtoms(xu, atomNames)
	if err != nil {
...
// _NET_WM_DESKTOP get
func WmDesktopGet(xconn *xgb.XConn, win xproto.Window) (uint, error) {
	return xprop.PropValNum(xprop.GetProperty(xu, win, "_NET_WM_DESKTOP"))
}

// _NET_WM_DESKTOP set
func WmDesktopSet(xconn *xgb.XConn, win xproto.Window, desk uint) error {
	return xprop.ChangeProp32(xu, win, "_NET_WM_DESKTOP", "CARDINAL",
		uint(desk))
}

// _NET_WM_DESKTOP req
func WmDesktopReq(xconn *xgb.XConn, win xproto.Window, desk uint) error {
	return WmDesktopReqExtra(xu, win, desk, 2)
}

// _NET_WM_DESKTOP req extra
func WmDesktopReqExtra(xconn *xgb.XConn, win xproto.Window, desk uint,
	source int,
) error {
...
func WmFullscreenMonitorsGet(xconn *xgb.XConn,
	win xproto.Window,
...
func WmFullscreenMonitorsSet(xconn *xgb.XConn, win xproto.Window,
...
func WmFullscreenMonitorsReq(xconn *xgb.XConn, win xproto.Window, edges *WmFullscreenMonitors) error {
	return WmFullscreenMonitorsReqExtra(xu, win, edges, 2)
}

// _NET_WM_FULLSCREEN_MONITORS req extra
func WmFullscreenMonitorsReqExtra(xconn *xgb.XConn, win xproto.Window, edges *WmFullscreenMonitors, source int) error {
	return ClientEvent(xu, win, "_NET_WM_FULLSCREEN_MONITORS", edges.Top, edges.Bottom, edges.Left, edges.Right, source)
}

// _NET_WM_HANDLED_ICONS get
func WmHandledIconsGet(xconn *xgb.XConn, win xproto.Window) (bool, error) {
	reply, err := xprop.GetProperty(xconn, win, "_NET_WM_HANDLED_ICONS")
	if err != nil {
		return false, err
	}
...
func WmHandledIconsSet(xconn *xgb.XConn, handle bool) error {
	var handled uint
	if handle {
		handled = 1
	} else {
	...
	return xprop.ChangeProp32(xu, xu.RootWin(), "_NET_WM_HANDLED_ICONS", "CARDINAL", handled)
}
...
// _NET_WM_ICON get
func WmIconGet(xconn *xgb.XConn, win xproto.Window) ([]WmIcon, error) {
...
// _NET_WM_ICON set
func WmIconSet(xconn *xgb.XConn, win xproto.Window, icons []WmIcon) error {
...
func WmIconGeometryGet(xconn *xgb.XConn,
	win xproto.Window,
) (*WmIconGeometry, error) {
...
func WmIconGeometrySet(xconn *xgb.XConn, win xproto.Window,
	geom *WmIconGeometry,
) error {
	rawGeom := make([]uint, 4)
...
func WmIconNameGet(xconn *xgb.XConn, win xproto.Window) (string, error) {
	return xprop.PropValStr(xprop.GetProperty(xu, win, "_NET_WM_ICON_NAME"))
}

// _NET_WM_ICON_NAME set
func WmIconNameSet(xconn *xgb.XConn, win xproto.Window, name string) error {
...
func WmMoveresize(xconn *xgb.XConn, win xproto.Window, direction int) error {
	return WmMoveresizeExtra(xu, win, direction, 0, 0, 0, 2)
}

// _NET_WM_MOVERESIZE req extra
func WmMoveresizeExtra(xconn *xgb.XConn, win xproto.Window, direction,
	xRoot, yRoot, button, source int,
) error {
...
// _NET_WM_NAME get
func WmNameGet(xconn *xgb.XConn, win xproto.Window) (string, error) {
	return xprop.PropValStr(xprop.GetProperty(xu, win, "_NET_WM_NAME"))
}

// _NET_WM_NAME set
func WmNameSet(xconn *xgb.XConn, win xproto.Window, name string) error {
...
func WmOpaqueRegionGet(xconn *xgb.XConn,
	win xproto.Window,
...
func WmOpaqueRegionSet(xconn *xgb.XConn, win xproto.Window,
	regions []WmOpaqueRegion,
) error {
...
// _NET_WM_PID get
func WmPidGet(xconn *xgb.XConn, win xproto.Window) (uint, error) {
	return xprop.PropValNum(xprop.GetProperty(xu, win, "_NET_WM_PID"))
}

// _NET_WM_PID set
func WmPidSet(xconn *xgb.XConn, win xproto.Window, pid uint) error {
	return xprop.ChangeProp32(xu, win, "_NET_WM_PID", "CARDINAL", pid)
}

// _NET_WM_PING req
func WmPing(xconn *xgb.XConn, win xproto.Window, response bool) error {
	return WmPingExtra(xu, win, response, 0)
}

// _NET_WM_PING req extra
func WmPingExtra(xconn *xgb.XConn, win xproto.Window, response bool,
...
// _NET_WM_STATE get
func WmStateGet(xconn *xgb.XConn, win xproto.Window) ([]string, error) {
	raw, err := xprop.GetProperty(xu, win, "_NET_WM_STATE")
	return xprop.PropValAtoms(xu, raw, err)
}

// _NET_WM_STATE set
func WmStateSet(xconn *xgb.XConn, win xproto.Window,
	atomNames []string,
) error {
	atoms, err := xprop.StrToAtoms(xu, atomNames)
	if err != nil {
...
// _NET_WM_STATE req
func WmStateReq(xconn *xgb.XConn, win xproto.Window, action int,
	atomName string,
) error {
...
func WmStateReqExtra(xconn *xgb.XConn, win xproto.Window, action int,
	first string, second string, source int,
) (err error) {
...
// _NET_WM_STRUT get
func WmStrutGet(xconn *xgb.XConn, win xproto.Window) (*WmStrut, error) {
...
// _NET_WM_STRUT set
func WmStrutSet(xconn *xgb.XConn, win xproto.Window, struts *WmStrut) error {
...
func WmStrutPartialGet(xconn *xgb.XConn,
	win xproto.Window,
) (*WmStrutPartial, error) {
	struts, err := xprop.PropValNums(xprop.GetProperty(xu, win,
...
func WmStrutPartialSet(xconn *xgb.XConn, win xproto.Window,
	struts *WmStrutPartial,
) error {
...
func WmSyncRequest(xconn *xgb.XConn, win xproto.Window, req_num uint64) error {
	return WmSyncRequestExtra(xu, win, req_num, 0)
}

// _NET_WM_SYNC_REQUEST req extra
func WmSyncRequestExtra(xconn *xgb.XConn, win xproto.Window, reqNum uint64,
	time xproto.Timestamp,
) error {
...
func WmSyncRequestCounter(xconn *xgb.XConn, win xproto.Window) (uint, error) {
...
// I'm pretty sure this needs 64 bit integers, but I'm not quite sure
// how to go about that yet. Any ideas?
func WmSyncRequestCounterSet(xconn *xgb.XConn, win xproto.Window,
	counter uint,
) error {
...
func WmUserTimeGet(xconn *xgb.XConn, win xproto.Window) (uint, error) {
	return xprop.PropValNum(xprop.GetProperty(xu, win, "_NET_WM_USER_TIME"))
}

// _NET_WM_USER_TIME set
func WmUserTimeSet(xconn *xgb.XConn, win xproto.Window, userTime uint) error {
	return xprop.ChangeProp32(xu, win, "_NET_WM_USER_TIME", "CARDINAL",
		userTime)
}

// _NET_WM_USER_TIME_WINDOW get
func WmUserTimeWindowGet(xconn *xgb.XConn,
	win xproto.Window,
) (xproto.Window, error) {
	return xprop.PropValWindow(xprop.GetProperty(xu, win,
...
// _NET_WM_USER_TIME set
func WmUserTimeWindowSet(xconn *xgb.XConn, win xproto.Window,
	timeWin xproto.Window,
) error {
...
func WmVisibleIconNameGet(xconn *xgb.XConn,
	win xproto.Window,
) (string, error) {
...
func WmVisibleIconNameSet(xconn *xgb.XConn, win xproto.Window,
	name string,
) error {
...
func WmVisibleNameGet(xconn *xgb.XConn, win xproto.Window) (string, error) {
	return xprop.PropValStr(xprop.GetProperty(xu, win, "_NET_WM_VISIBLE_NAME"))
}

// _NET_WM_VISIBLE_NAME set
func WmVisibleNameSet(xconn *xgb.XConn, win xproto.Window, name string) error {
...
func WmWindowOpacityGet(xconn *xgb.XConn, win xproto.Window) (float64, error) {
...
func WmWindowOpacitySet(xconn *xgb.XConn, win xproto.Window,
	opacity float64,
) error {
...
func WmWindowTypeGet(xconn *xgb.XConn, win xproto.Window) ([]string, error) {
...
func WmWindowTypeSet(xconn *xgb.XConn, win xproto.Window,
	atomNames []string,
) error {
	atoms, err := xprop.StrToAtoms(xu, atomNames)
	if err != nil {
...
// _NET_WORKAREA get
func WorkareaGet(xconn *xgb.XConn) ([]Workarea, error) {
...
// _NET_WORKAREA set
func WorkareaSet(xconn *xgb.XConn, workareas []Workarea) error {
